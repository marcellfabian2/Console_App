            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (input == "q")
                    {
                        ...
                        {
                            Console.WriteLine("Már a gyökérkönyvtárban tartózkodsz!");
                    ...
                    else if (input == "rf")
                    {
                        ...
                        {
                            Console.WriteLine("Ismeretlen mód! (Nyomj Entert)");
                            Console.ReadLine();
                            continue;
                        }

                        Console.WriteLine("\nRENDEZETT FÁJLOK (másold ki a kívánt fájl nevét):");
                    ...
                    {
                        Console.Write("Add meg a célmappa nevét (az asztalon jön létre, üres ha nincs szükség mappára): ");
